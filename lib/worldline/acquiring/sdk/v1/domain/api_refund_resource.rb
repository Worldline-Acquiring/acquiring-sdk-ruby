...
require 'worldline/acquiring/sdk/v1/domain/sub_operation_for_refund'
    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Array<Worldline::Acquiring::SDK::V1::Domain::SubOperationForRefund>] operations
          ...
          class ApiRefundResource < Worldline::Acquiring::SDK::Domain::DataObject
